...
public class ControlsPanel extends JPanel {
    ...
    private AStarPathFinding algorithm;
    private SelectionType selectionType;
    
    private  JComboBox<String> selector;

    public ControlsPanel(int width, int height, AStarPathFinding algorithm) {
        ...
        selector.addItem("Starting Point");
        selector.addItem("Ending Point");
